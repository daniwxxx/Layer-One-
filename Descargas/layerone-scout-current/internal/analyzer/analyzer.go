...
func AnalyzePerson(p model.Person) model.Person {
	...
	s := model.Signals{
		...
		Regularity:            behavior.Regularity,
		QuestionRate:          behavior.QuestionRate,
		ExclamationRate:       behavior.ExclamationRate,
		HashtagRate:           behavior.HashtagRate,
		MentionRate:           behavior.MentionRate,
		LinkRate:              behavior.LinkRate,
